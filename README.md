...
This branch represents the final step of the workshop.
...
To explicitly deploy the data model and seed data into a local SQLite database, you can run:
...
- Create the tables based on `schema.cds`
- Insert the CSV data from `db/data/`
...
This concludes the workshop implementation. 🌦️🚀
